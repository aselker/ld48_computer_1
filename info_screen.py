...
"""DEEPER MICROCODE
Deeper Microcode is a simple language, with no flow control.  The fundamental data type of Deeper Microcode is the bit; input and output is in the form of registers that represent numbers, but Deeper Microcode only works with single bits.  Each line is a single command.  This is an example program:
